                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle text-center mb-0">
                            ...
                            <tbody class="fs-6">
                                ...
                                <tr>
                                    <td class="fw-bold text-secondary">{{ $booking->teacher_id }}</td>
                                    <td>
                                        <span class="badge {{ $booking->booking_type == 'حجز معمل' ? 'bg-info text-dark' : 'bg-secondary text-white' }} px-2 py-1">
                                            {{ $booking->booking_type }}
                                        </span>
                                    </td>
                                    <td class="fw-bold text-primary">{{ $booking->target_name }}</td>
                                    <td class="small fw-semibold text-dark">
                                        من: {{ $booking->start_date }} <br> إلى: {{ $booking->end_date }}
                                    </td>
