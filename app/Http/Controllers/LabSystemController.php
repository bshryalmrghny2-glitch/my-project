   ...
   public function storeBooking(Request $request)
    {
        ...
        // دمج التاريخ والوقت في صيغة dateTime لتتوافق مع نوع الحقل في قاعدة البيانات
        ...
        DB::table('lab_bookings')->insert([
            ...
            'resource_name' => $request->target_name, // 🟢 تم التعديل هنا ليتطابق مع عمود resource_name
            'start_time'    => $start_time,           // 🟢 تم التعديل هنا ليتطابق مع عمود start_time (dateTime)
            'end_time'      => $end_time,             // 🟢 تم التعديل هنا ليتطابق مع عمود end_time (dateTime)
            'status'        => 'قيد الانتظار',
            'created_at'    => now(),
            'updated_at'    => now()
        ]);
